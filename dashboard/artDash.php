...
<?php
  ...
  if (isset($_POST['upload'])) {
    ...
    $sql= "INSERT INTO art_dash (title, text, image, artist) VALUES ('$title', '$text', '$image', '$artist')";
    mysqli_query($db, $sql); //stores submitted data into the database table art_dash

    // move uploaded image into the folder images
    if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
        header("location: artDash.php?uploadsuccess");
...
<body>
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="row">
          <h3 style="margin: auto; font-weight: 800;">Cultural Arts</h3>
        </div>
              ...
              <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Cultural Arts</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                    <form method="post" action="artDash.php" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" id="exampleFormControlInput1" name= "artist" placeholder="Artist..." required>
                      </div>
        ...
        <div class="row">
          <div class="container-fluid">
            <div class="displayArt" align="center">
              ...
              <?php
                    ...
                    $sql ="SELECT * FROM art_dash ORDER BY id ASC LIMIT $start_from, $limit";
              ...
              ?>
                ...
                <?php
                  $result_db= mysqli_query($db, "SELECT COUNT(id) FROM art_dash");
                  
                ?>
                <div>
                  
                  <?php
                    $numresult= mysqli_query($db, "SELECT * FROM art_dash");
                  ...
                  <p><b>Total records: <?php echo $totalrows; ?></b></p>
                    ...
                    <div>
                      <table class="table table-bordered table-striped table-responsive-sm text-center" id="artTable">
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><a href="delArt.php?id=<?php echo $row['id'];?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?'); " title="Delete this record"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                      ...
                      for ($i=1; $i<=$total_pages; $i++) {
                                    $pagLink .= "<li class='page-item'><a class='page-link' href='artDash.php?page=".$i."'>".$i."</a></li>";	
                      }
                      echo $pagLink . "</ul>"; 
        ...
        <!--START OF EDIT MODAL-->
        <!-- Modal -->
        <div class="modal fade" id="editArtModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <form method="post" action="editArt.php" enctype="multipart/form-data">
                      <div class="modal-body">
