...
<?php
  ...
  if (isset($_POST['upload'])) {
    ...
    $target = "archeramores/marahuyo-archive-system/images/".basename($_FILES['image']['name']);
                    ...
                    <div>
                      <table class="table table-bordered table-striped table-responsive-sm text-center" id="festTable">
                        ...
                        <tr>
                          ...
                          <td><?php echo "<img src='archeramores/marahuyo-archive-system/images/".$row['image']."' class='tableImg'>"; ?></td>
                          <td>
