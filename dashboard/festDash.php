...
<?php
  ...
  if (isset($_POST['upload'])) {
    ...
    $target = "https://github.com/archeramores/marahuyo-archive-system/images/".basename($_FILES['image']['name']);
    ...
    $sql= "INSERT INTO fest_dash (title, text, image, location, month) VALUES ('$title', '$text', '$image', '$location','$month')";
    mysqli_query($db, $sql); //stores submitted data into the database table fest_dash

    // move uploaded image into the folder images
    if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
        header("location: festDash.php?uploadsuccess");
...
<body>
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="row">
          <h3 style="margin: auto; font-weight: 800;">Festive Events</h3>
        </div>
              ...
              <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Festive Events</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                    <form method="post" action="festDash.php" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <select placeholder="MM" name="month" id="month" required>
        ...
        <div class="row">
          <div class="container-fluid">
            <div class="displayFest" align="center">
              ...
              ?>
                ...
                <?php
                  $result_db= mysqli_query($db, "SELECT COUNT(id) FROM fest_dash");
                  
                ?>
                <div>
                  
                  <?php
                    $numresult= mysqli_query($db, "SELECT * FROM fest_dash");
                  ...
                  <p><b>Total records: <?php echo $totalrows; ?></b></p>
                    ...
                    <div>
                      <table class="table table-bordered table-striped table-responsive-sm text-center" id="festTable">
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><?php echo "<img src='https://github.com/archeramores/marahuyo-archive-system/images/".$row['image']."' class='tableImg'>"; ?></td>
                          <td>
                            <button type="button" class="btn btn-success editbtn" title="Edit this record"><i class="fa fa-pencil"></i></button>
                          </td>
                          <td><a href="delFest.php?id=<?php echo $row['id'];?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?'); " title="Delete this record"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                      ...
                      for ($i=1; $i<=$total_pages; $i++) {
                                    $pagLink .= "<li class='page-item'><a class='page-link' href='festDash.php?page=".$i."'>".$i."</a></li>";	
                      }
                      echo $pagLink . "</ul>"; */
        ...
        <!--START OF EDIT MODAL-->
        <!-- Modal -->
        <div class="modal fade" id="editFestModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <form method="post" action="editFest.php" enctype="multipart/form-data">
                      <div class="modal-body">
                      ...
                      <div class="form-group">
                        <select placeholder="MM" name="update_month" id="update_month" required>
                          <option name="" value="" style="display:none;">Month</option>
                          <option name="January" value="January">January</option>
                          <option name="February" value="February">February</option>
                          <option name="March" value="March">March</option>
  ...
  <script>
    ...
    table = document.getElementById("festTable");
