...
<body>
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="row">
          <h3 style="margin: auto; font-weight: 800;">Cultural Music</h3>
        </div>
              ...
              <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Cultural Music</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                    <form method="post" action="songDash.php" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" id="exampleFormControlInput1" name= "artist" placeholder="Artist/Location..." required>
                      </div>
              
                      <div>           
                        <input type="file" class="form-control-file" id="song" name="song" accept=".mp3" multiple required>
                      </div>
            ...
            <div class="displayArt" align="center">
              ...
              ?>
                ...
                <div>
                  ...
                  <?php
                    $numresult= mysqli_query($db, "SELECT * FROM song_dash");
                  ...
                  <p><b>Total records: <?php echo $totalrows; ?></b></p>
                    ...
                    <div>
                      <table class="table table-bordered table-striped table-responsive-sm text-center" id="songTable">
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><a href="delSong.php?id=<?php echo $row['id'];?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?'); " title="Delete this record"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
        ...
        <!--START OF EDIT MODAL-->
        <!-- Modal -->
        <div class="modal fade" id="editSongModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <form method="post" action="editSong.php" enctype="multipart/form-data">
                      <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name= "artist" id="artist" placeholder="Artist/Location..." required>
                      </div>
