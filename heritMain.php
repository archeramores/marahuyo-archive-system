<!DOCTYPE html>
<head>
<title>Intangible Heritage|Marahuyo</title>
    <meta charset="utf-8">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu " aria-labelledby="navbarDropdown">
                            <li class="active"><a href="./heritMain.php" class="dropdown-item active">Intangible Heritage</a></li>
        ...
        <div class="row-fluid">
            <div class="bg-white rounded shadow-sm p-4 mb-4 restaurant-detailed-ratings-and-reviews">
                    ...
                    <?php
                      ...
                      $sqlheritMain ="SELECT * FROM herit_dash ORDER BY id ASC LIMIT $start_from, $limit";
                      $result=mysqli_query($dbMain, $sqlheritMain);
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="reviews-members-body">
                                    <p class="d-inline-block text-justify p-sm-5 p-md-4 p-lg-1" id="loc" name="loc">
                                        <i><?php echo $row['location'];?>, Batangas</i>
                                    </p></br>
                    ...
                    <?php
                        ...
                        $result_db= mysqli_query($dbMain, "SELECT COUNT(id) FROM herit_dash");
                        ...
                        for ($i=1; $i<=$total_pages; $i++) {
                            ...
                            $pagLink .= "<li class='page-item '><a class='page-link text-white bg-danger' href='heritMain.php?page=".$i."'>".$i."</a></li>";	
                        }
                        echo $pagLink .="</ul>";
                        echo "</footer></div>"; 
